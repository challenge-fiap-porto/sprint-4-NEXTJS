  ...
  return (
    <main>
      ...
      <div className="img-adjustment">
        <div>
          <Image className="img-title2" src={pedalEssencial} alt="Homem mexendo na corrente da bike" />
        ...
        <div>
          <Image className="img-title2" src={pedalLeve} alt="Homem colocando banco da bike" />
        ...
        <div>
          <Image className="img-title2" src={pedalElite} alt="Homem mexendo no tablet ao lado da bike" />
